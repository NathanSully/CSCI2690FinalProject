...
```
cd existing_repo
git remote add origin https://git.cs.dal.ca/ngo/2690-final-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.dal.ca/ngo/2690-final-project/-/settings/integrations)
